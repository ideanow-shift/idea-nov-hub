...
with rows(provider, target_type, target_id, channel_id, channel_name, purpose, is_active) as (
  values
    ('line_works', 'global', null::uuid, 'REPLACE_HR_LINE_WORKS_CHANNEL_ID', 'NOV Navi 総務人事問い合わせ', 'concierge.department_inquiry.hr', true),
    ('line_works', 'global', null::uuid, 'REPLACE_ACCOUNTING_LINE_WORKS_CHANNEL_ID', 'NOV Navi 経理問い合わせ', 'concierge.department_inquiry.accounting', true),
    ('line_works', 'global', null::uuid, 'REPLACE_EDUCATION_LINE_WORKS_CHANNEL_ID', 'NOV Navi 教育問い合わせ', 'concierge.department_inquiry.education', true),
    ('line_works', 'global', null::uuid, 'REPLACE_SALES_LINE_WORKS_CHANNEL_ID', 'NOV Navi 営業問い合わせ', 'concierge.department_inquiry.sales', true),
    ('line_works', 'global', null::uuid, 'REPLACE_FC_LINE_WORKS_CHANNEL_ID', 'NOV Navi FC問い合わせ', 'concierge.department_inquiry.fc', true),
    ('line_works', 'global', null::uuid, 'REPLACE_SYSTEM_LINE_WORKS_CHANNEL_ID', 'NOV Navi システム問い合わせ', 'concierge.department_inquiry.system', true)
),
updated as (
