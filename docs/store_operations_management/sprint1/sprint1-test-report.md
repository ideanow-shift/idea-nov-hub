...
最終化後:
- Sprint 1 / Store Sales回帰: 112/112 PASS
...
- Permission-aware Scope: 代表＝全店/直営/FC、営業部長＝直営、エリアマネージャー＝担当店舗、店長＝自店舗を実画面確認
- Scope別見出し: 全店/直営/FC/担当店舗/立川店を確認
- ブラウザConsole Error: 0件
- `git diff --check`: PASS

リポジトリ全Node回帰:
- 変更後: 431件中416 PASS / 15 FAIL
