# Store Operations Sealed Snapshot v1.3.0 Corrective
...
The immutable v1.2.0 package remains under `store-operations-sealed-snapshot-v1`.
...
v1.3.0 does not require global PUBLIC ACL hardening. PUBLIC-derived TEMP and
...
```powershell
node review/store-operations-sealed-snapshot-v1-3/security-corrective.test.mjs
node review/store-operations-sealed-snapshot-v1-3/sealed-snapshot-package.test.mjs
```
...
node review/store-operations-sealed-snapshot-v1-3/local-postgresql17-security.test.mjs
```
