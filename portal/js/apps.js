...
export const DEMO_APPS = [
  ...
  { ...appBase, appId: "nov-talent", appName: "求人管理", description: "学生・選考・イベント・次回対応を管理", url: "./talent/", category: "人財", icon: "human-capital-investment", requiredLevel: 1, isFeatured: false, priority: 64 },
