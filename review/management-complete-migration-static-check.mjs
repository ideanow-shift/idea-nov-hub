...
const required = [
  ...
  [files.html, 'class="section-tab is-active" data-section="finance"'],
  [files.html, 'class="section-tab" data-section="stores"'],
  [files.html, 'class="section-tab" data-section="dataops"'],
  [files.html, 'id="finance-view-tabs"'],
  ...
  [files.app, 'elements.financeViewTabs.hidden = !FINANCE_VIEWS.has(state.view)'],
