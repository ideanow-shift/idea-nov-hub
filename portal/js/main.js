...
import { CATEGORY_ORDER, DEMO_APPS, ensureStoreOperationsLaunchTarget, getVisibleApps, loadAppIconRegistry, resolveAppIcon } from "./apps.js?v=store-operations-hub-access-20260909-2";
...
} from "./nov-navi-dashboard.js?v=hr-viewer-employee-directory-20260911-1";
import {
...
function sortPortalApps(apps = []) {
  return dedupePortalApps(ensureStoreOperationsLaunchTarget(normalizeManagementPlatformApps(apps)))
