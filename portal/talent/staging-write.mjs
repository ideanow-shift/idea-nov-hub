...
export function createStagingCandidateClient({
  ...
  return Object.freeze({
    ...
    dailyWorkflow: () => request("/api/talent/v1/daily-workflow"),
    recordCommunication: (payload) => request("/api/talent/v1/communications", { method: "POST", body: payload }),
    mutateNextAction: (payload) => request("/api/talent/v1/next-actions", { method: "POST", body: payload }),
