...
function isNonPositionLabel(value) {
  return /会長夫人|創業者夫人|夫人|レセプション/.test(String(value || ""));
}

function inferRoleLabel() {
  const context = getHubContext();
  if (context.positionName && !isNonPositionLabel(context.positionName)) return context.positionName;
