...
Run ID binding: package hash, private Query-registry hash, operator, reviewer, authorized-at, execution window
...
sanitized outcome, rollback/close/component-cleanup status, artifact
prepare/commit-or-abort/revoke result, and revocation confirmation. Do not
