...
export const DEMO_APPS = [
  ...
  { ...appBase, appId: "store-sales-preview", appName: "店舗営業管理", description: "店舗ごとの売上・利益と今月の確認項目を確認", url: "./store-sales/", category: "経営", icon: "store-sales-preview", requiredLevel: 3, allowedTags: ["executive", "department_manager", "store_manager", "franchise_owner"], isFeatured: true, priority: 42 },
