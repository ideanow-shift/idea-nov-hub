...
export const DEMO_APPS = [
  ...
  { ...appBase, appId: "education-web", appName: "教育部WEBアプリ", description: "教育動画・技術マニュアル・研修予定", url: "https://script.google.com/macros/s/AKfycbxKLThF4TN18-OwaOFKbqwoPPSAHB7HH4v3_IkTXEmAGrhDJyzS1GfkfC1GFGiA7vUZew/exec?page=home", category: "教育", icon: "education-web", requiredLevel: 1, isFeatured: true, priority: 30 },
  ...
  { ...appBase, appId: "idea-link", appName: "IDEA LINK", description: "サンクス投稿と理念行動の共有", url: "./idea-link-app/", category: "称賛", icon: "idea-link", requiredLevel: 1, isFeatured: false, priority: 88 },
