...
const SQL_ARTIFACTS = Object.freeze({
  ...
  'SOCE-QP01-SOURCE-READONLY': Object.freeze({ sqlFile: 'queries/SOCE-QP01-SOURCE-READONLY.sql', sqlSha256: 'fd150058a1420ae51c99c6380a28d53b35eabe032523db9f5898bd3d5e709ed6' }),
  'SOCE-QP01-TARGET-READONLY': Object.freeze({ sqlFile: 'queries/SOCE-QP01-TARGET-READONLY.sql', sqlSha256: 'b54e3eafbb07eb686203aa287aa47efd22cf77babf844f6462d2a2ecb0391fe2' }),
  'SOCE-QP02-SOURCE-SCHEMA-COLUMN-MAP': Object.freeze({ sqlFile: 'queries/SOCE-QP02-SOURCE-SCHEMA-COLUMN-MAP.sql', sqlSha256: '9df8374517dcfd3bf4bbe90b91f84062f5fb68b4ae1c65be1364374eb3a79699' }),
  ...
  'SOCE-QP04-EMPLOYEE-AUTHORIZATION-SUMMARY': Object.freeze({ sqlFile: 'queries/SOCE-QP04-EMPLOYEE-AUTHORIZATION-SUMMARY.sql', sqlSha256: '558e0b9b83aef9e1f5aa8bad361df229afd8d2c90739f57616f7488748f84193' }),
  ...
  'SOCE-QP06-TARGET-PRESTATE': Object.freeze({ sqlFile: 'queries/SOCE-QP06-TARGET-PRESTATE.sql', sqlSha256: 'c45f8d680a3a8650f60774eaac8f84ca3e6c3fb3538cf29ebbc606563b0c7cd5' }),
...
const READ_ONLY_EVIDENCE_TYPES = Object.freeze({
  ...
  login_role_count: INTEGER,
  noinherit_violation_count: INTEGER,
  connection_limit_violation_count: INTEGER,
  valid_until_violation_count: INTEGER,
  membership_edge_count: INTEGER,
  ...
  direct_application_routine_execute_count: INTEGER,
...
export const FIXED_QUERY_PACKS = Object.freeze([
  ...
  pack('SOCE-QP02', 'stage0', 'Schema and column contract attestation', [
    ...
    }, ['attestation_side', 'object_namespace', 'object_label', 'column_label'], { queryVersion: '1.0.1', outputSchemaVersion: '1.0.1' }),
  ...
  pack('SOCE-QP04', 'stage1', 'Employee, role, position, department, and assignment evidence', [
    query('SOCE-QP04-EMPLOYEE-AUTHORIZATION-SUMMARY', 'source', 'Summarize eligible executive, sales-head, AM, and manager evidence', {
      ...
      sales_department_head_candidate_count: INTEGER,
      sales_department_head_state: STRING,
      sales_department_head_employee_key: NULLABLE_STRING,
      sales_department_head_employee_number: NULLABLE_STRING,
    ...
    }, ['sales_department_head_state', 'sales_department_head_employee_key'], { queryVersion: '1.0.2', outputSchemaVersion: '1.0.2' }),
  ...
  pack('SOCE-QP06', 'stage1', 'Target pre-state attestation', [
    query('SOCE-QP06-TARGET-PRESTATE', 'target', 'Confirm Staging has no partial Canonical Master, consumer-anchor, or access-contract population', {
      canonical_corporation_count: INTEGER,
...
export function assertFixedQueryRegistry(registry = FIXED_QUERY_REGISTRY) {
  ...
  const valid = Array.isArray(registry) && registry.length === 16
    ...
    && registry.every((entry) => entry && required.every((field) => Object.hasOwn(entry, field))
      ...
      && entry.queryVersion === (entry.queryId.endsWith('-READONLY')
        ? READ_ONLY_QUERY_VERSION
        : entry.queryId === 'SOCE-QP02-SOURCE-SCHEMA-COLUMN-MAP' ? '1.0.1'
          : entry.queryId === 'SOCE-QP06-TARGET-PRESTATE' ? '1.0.1'
          : entry.queryId === 'SOCE-QP04-EMPLOYEE-AUTHORIZATION-SUMMARY' ? '1.0.2' : QUERY_VERSION)
      && entry.expectedOutputSchemaVersion === (entry.queryId.endsWith('-READONLY')
        ? READ_ONLY_OUTPUT_SCHEMA_VERSION
        : entry.queryId === 'SOCE-QP02-SOURCE-SCHEMA-COLUMN-MAP' ? '1.0.1'
          : entry.queryId === 'SOCE-QP06-TARGET-PRESTATE' ? '1.0.1'
          : entry.queryId === 'SOCE-QP04-EMPLOYEE-AUTHORIZATION-SUMMARY' ? '1.0.2' : OUTPUT_SCHEMA_VERSION));
