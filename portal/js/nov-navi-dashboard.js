...
const SYSTEMS = [
  ...
  { category: "経営管理", title: "社員名簿", subtitle: "社員情報を閲覧", status: "available", aliases: ["core-master-admin", "master-admin"], shortcuts: ["社員一覧", "所属情報"], allowedRoles: ["executive", "hr.viewer"], hideForAdmin: true, audience: "執行役員・閲覧許可者" },
