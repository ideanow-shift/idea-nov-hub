...
assert.doesNotMatch(`${inventory}\n${project}\n${comparison}\n${secrets}\n${board}\n${summary}\n${sandbox}\n${cleanup}\n${reuse}\n${build}\n${checklist}\n${connection}\n${goNoGo}`, /postgres(?:ql)?:\/\/[^\s]+|sb_secret_[^\s]+|zgkoofphhivesclehrom/i);
process.stdout.write("RESULT staging provisioning and sandbox build gate are safe and static PASS\n");
