const SAFE_KEY = /^(schema_name|relation_name|relation_kind|table_name|column_name|data_type|is_nullable|row_count|candidate_count|foreign_key_count|dependency_count|function_count|rls_enabled|policy_count|transaction_read_only)$/;
