...
It contains the approved Source and Target object set, physical column map,
types, nullability, constraints, relations, approved Pack hashes, and a Stage 0
evidence digest. The repository stores no physical-schema claim as a Production
fact.
...
| Query Pack IDs/order/schema are exact | Required. |
