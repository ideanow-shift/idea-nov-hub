const SAFE_KEY = /^(schema_name|relation_name|relation_kind|table_name|column_name|data_type|is_nullable|row_count|candidate_count|foreign_key_count|dependency_count|function_count|rls_enabled|policy_count|transaction_read_only|primary_key_count|unique_constraint_count|index_count|role_category|privilege_kind|policy_command|bypass_rls|function_name|security_definer|argument_types|return_type)$/;
