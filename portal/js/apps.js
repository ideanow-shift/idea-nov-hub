...
export const DEMO_APPS = [
  ...
  { ...appBase, appId: "education-web", appName: "教育部WEBアプリ", description: "教育動画・技術マニュアル・研修予定", url: "./education-app/", category: "教育", icon: "education-web", requiredLevel: 1, isFeatured: true, priority: 30 },
  ...
  { ...appBase, appId: "management-system", appName: "経営管理システム", description: "法人・店舗・データ状況を確認", url: "./management-app/", category: "経営", icon: "management-system", requiredLevel: 3, allowedTags: ["executive", "backoffice", "accounting", "area_manager", "store_manager"], isFeatured: false, priority: 60 },
  { ...appBase, appId: "store-sales-management", appName: "店舗営業管理", description: "売上・利益・KPI・店舗運営を確認", url: "./store-sales/index.html", category: "経営", icon: "store-sales-management", requiredLevel: 3, allowedTags: ["executive", "representative", "department_manager", "sales_manager", "area_manager", "store_manager"], isFeatured: true, priority: 42 },
  ...
  { ...appBase, appId: "idea-link", appName: "サンクスコイン", description: "感謝・称賛をコインで届ける", url: "./idea-link-app/", category: "称賛", icon: "idea-link", requiredLevel: 1, isFeatured: false, priority: 88 },
  ...
  { ...appBase, appId: "human-capital-investment", appName: "人財投資管理システム", description: "育成投資と人財指標を確認", url: "./talent/", category: "人財", icon: "human-capital-investment", requiredLevel: 4, allowedTags: ["executive", "backoffice"], isFeatured: false, priority: 64 },
