...
const ready = { candidates: true, selectionHistory: true, communications: true, nextActions: true, fairAttributions: true, schoolMasters: true };
...
test("committed schema and runtime pin Contract v1.0.0", async () => {
  ...
  assert.deepEqual(schema.properties.data.required.sort(), ["recruiting_intelligence_contract_version", "generatedAt", "sourceCoverageState", "sourceAvailability", "currentPosition", "funnel", "graduationYears", "schoolProgress", "assigneeWorkload", "priorities", "fairResults", "managementDiagnostics", "targets"].sort());
});
